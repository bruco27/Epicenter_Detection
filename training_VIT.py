...
def main():
    ...
    train_csv = "/home/ebuccoliero/Split_Data/Point/ViT/train_data_grouped.csv"
    val_csv = "/home/ebuccoliero/Split_Data/Point/ViT/val_data_grouped.csv"
    test_csv = "/home/ebuccoliero/Split_Data/Point/ViT/test_data_grouped.csv"
    checkpoint_path = "/home/ebuccoliero/Split_Data/Point/ViT/Training_output/checkpoint_vit.pth"
    ...
    model = create_model('vit_base_patch16_224', pretrained=True, num_classes=2, in_chans=5).to(device)
    ...
    # Denormalize predictions and save results
    ...
    output_dir = "/home/ebuccoliero/Split_Data/Point/ViT/Training_output"
