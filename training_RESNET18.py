...
def main():
    ...
    train_csv = "/home/ebuccoliero/Split_Data/Point/ResNet18/train_data_grouped.csv"
    val_csv = "/home/ebuccoliero/Split_Data/Point/ResNet18/val_data_grouped.csv"
    test_csv = "/home/ebuccoliero/Split_Data/Point/ResNet18/test_data_grouped.csv"
    checkpoint_path = "/home/ebuccoliero/Split_Data/Point/ResNet18/Training_output/checkpoint_norm.pth"
    ...
    model = create_model('resnet18', pretrained=True, num_classes=2, in_chans=5).to(device)
